...
function cityFAQ(city, stateCode, shops, config) {
  ...
  faqs.push(faqEntry(
    `Can I sell coins in ${city}?`,
    `Yes — many ${city} ${nounPl} buy individual coins, paper currency, and entire collections, not just sell them. Look for listings tagged Buy/sell or Appraisals above, and call ahead to confirm what a shop is currently buying.`
  ));

  faqs.push(faqEntry(
    `Where can I get a coin appraisal in ${city}?`,
    `Several ${city} ${nounPl} offer in-person coin appraisals. An appraisal tells you what your coins are realistically worth before you sell. Bring the coins uncleaned, and ask whether the shop charges an appraisal fee.`
  ));
